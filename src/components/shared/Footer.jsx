  ...
  render() {
    return (
      <Fragment>
        <div
          id="contacts-section"
          class="g-bg-black-opacity-0_9 g-color-white-opacity-0_8 g-py-60"
        >
          <div class="container">
            <div class="row">
              <div class="col-lg-3 col-md-6 g-mb-40 g-mb-0--lg">
                ...
                <p>
                  About Unify dolor sit amet, consectetur adipiscing elit.
              ...
              <div class="col-lg-3 col-md-6">
                ...
                <address
                  ...
                  style={{
                    backgroundImage: "url(../../assets/img/maps/map2.png"
                  }}
                >
            ...
            <div class="row">
              ...
              <div class="col-md-4 align-self-center">
                <ul class="list-inline text-center text-md-right mb-0">
                  <li
                    class="list-inline-item g-mx-10"
                    data-toggle="tooltip"
                    data-placement="top"
                    title="Facebook"
                  >
